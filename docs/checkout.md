...
2. Выбор способа получения заказа. Если выбран способ с самовывозом, нужно выбрать пункт самовывоза. Если выбран способ с доставкой на дом, нужно указать адрес доставки:
...
3. Ввод информации об оплате, а именно - выбор способа оплаты из списка, которые бывают следующих типов:
