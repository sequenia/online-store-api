...
2. Передать выбранный город на сервер, сохранить его в базе данных в профиле пользователя. Сервер при обработке любого API-запроса сможет получить город пользователя из базы данных.
