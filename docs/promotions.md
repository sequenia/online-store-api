...
Интернет магазин может предоставлять скидки, если пользователь выполнит определенные условия.
...
Пример структуры данных и выдачи информации о заказе с корректировками (Информация, не связанная с корректировками, не указана):
